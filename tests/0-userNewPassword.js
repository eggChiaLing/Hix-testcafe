...
// /html/body/div[1]/div/div/div/div/div[2]/form/div[1]/input 使用者名稱
const userName = Selector('#app').child('div').child('div').child('div').child('div').nth(1).child('form').child('div').nth(0).child('input')
// /html/body/div[1]/div/div/div/div/div[2]/form/div[2]/div[1]/input 密碼
...
// /html/body/div[1]/div/div/div/div/div[2]/form/button 登入
